...
int	main(void)
{
	...
	buf[res_1 - 1] = '\0';
	printf("\033[1;32m sys result -> \033[0m \033[1;31m buf \033[0m: %s | \033[1;31m returned \033[0m: %d\n", buf, res_1);
	buf = malloc(1024);
	res_2 = ft_read(0, buf, 1024);
	buf[res_2 - 1] = '\0';
	printf("\033[1;33m my result -> \033[0m \033[1;31m buf \033[0m: %s | \033[1;31m returned \033[0m: %d\n\n", buf, res_2);
	...
	close(fd);
	printf("\033[1;32m sys result -> \033[1;31m buf \033[0m: %s |\033[1;31m returned \033[0m: %d\n", buf, res_1);
	fd = open("file_for_ft_read", O_CREAT | O_RDWR, 0644);
	buf = malloc(1024);
	res_2 = ft_read(fd, buf, 1024);
	close(fd);
	printf("\033[1;33m my result -> \033[1;31m buf \033[0m: %s |\033[1;31m returned \033[0m: %d\n\n", buf, res_2);

	buf = malloc(1024);
	res_1 = read(-1, buf, 1024);
	printf("\033[1;32m sys return -> \033[0m %d \n", res_1);
